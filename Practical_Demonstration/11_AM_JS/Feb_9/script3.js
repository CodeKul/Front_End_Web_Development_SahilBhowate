...
function displayFilmData() {
  let filmContentAreaTag = document.getElementById("filmContentArea");
  ...
  <div><b>Year :</b>${singleFilmObject.Year}</div>
  <div><b>Rated :</b>${singleFilmObject.Rated}</div>
  <div><b>Released :</b>${singleFilmObject.Released}</div>
  <div><b>Runtime :</b>${singleFilmObject.Runtime}</div>
  <div><b>Genre :</b>${singleFilmObject.Genre}</div>
  <hr/>
  `;
  }

  filmContentAreaTag.innerHTML = filmString;
}
